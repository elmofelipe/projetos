			...
			<div class="row">
				<div class="col-lg-3 col-12">
					<div class="card" style="">
						<img src="images/revisao.jpg" class="img-fluid" alt="">
						<div class="card-body">
							<div class="media">
								<img src="images/foto.svg" class="align-self-center mr-3" alt="...">
								<div class="media-body">
									<p class="mt-20">Nova fucionalidade...</p>
