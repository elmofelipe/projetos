...
<section id="jobs" class="pb-30 pt-30 pb-md-30 pt-md-30 light">
	<div class="container">
        ...
        <ul>
          ...
          <li><a href="#">Adicionar Clientes</a></li>
        </ul>
      </div>
		</div> 
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="row">
						<div class="col-lg-6">
							<h1><strong>Adicione o Cliente</strong><br>e quem vai aprovar os Jobs</h1>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-12">
									...
									<input type="email" class="form-control"  placeholder="Email do aprovador" name="email">
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-lg-12 informacao">
									<p>Você sempre pode alterar o aprovador em 'configurações' no menu do cliente</p>
								</div>
							</div>
						</div><!-- 6 -->
						<div class="col-lg-6 pl-12 editar-capa">
							<a href="#" class="upload">
								<div class="texto">
									...
									Faça upload da logo do cliente arrantado ou clicando aqui
								</div>
							</a>
						</div>
					</div>
    ...
    <div class="container-fluid shadow concluir">
			<div class="row justify-content-end">
				...
				<div class="col-lg-3 col-6">
					<a href="#" class="btn btn-success" data-toggle="modal" data-target="#concluir">Concluir</a>
				</div>
			</div>
		</div>
