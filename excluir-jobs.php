					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="row justify-content-end">
								...
								<button type="button" class="btn btn-excluir-item">Excluir item</button>
								</div>
								<div class="col-lg-4 col">
						...
						<div class="col-lg-6 pl-12 editar-capa">
							<a href="#" class="link"><img src="images/Union.svg" class=""> Editar imagem</a>
							<a href="#" class="upload">
								<img src="images/revisao.jpg" class="img-fluid img-revisao">
							</a>
							<div class="descricao-job text-center">
